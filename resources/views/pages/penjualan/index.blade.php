    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-slate-400 text-sm flex items-center gap-2">
                ...
                Manajemen data transaksi penjualan obat ke pelanggan
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-slate-800 rounded-xl p-5 border border-slate-700 shadow-sm">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-slate-100">2.5%</h3>
            </div>
        </div>
            ...
            <form class="flex flex-col lg:flex-row gap-3">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <select class="px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors">
                        ...
                        <option value="PEL01">Umum / Tanpa Nama</option>
                        <option value="PEL02">Budi Santoso</option>
                        <option value="PEL03">Siti Aminah</option>
                    </select>
                ...
                <tbody class="divide-y divide-slate-700/50">
                    ...
                    <tr class="hover:bg-slate-700/20 transition-colors">
                        <td class="px-5 py-4 whitespace-nowrap">
                            <span class="text-sm font-mono font-medium text-emerald-400">JUAL-202402001</span>
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-slate-300">14 Februari 2024, 08:30</span>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-slate-500">Kode: PEL-001</span>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap">
                        ...
                        <td class="px-5 py-4 whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button type="button" class="p-1.5 text-slate-400 hover:text-red-400 hover:bg-slate-700 rounded transition-colors" title="Batalkan/Hapus Penjualan">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <tr class="hover:bg-slate-700/20 transition-colors">
                        <td class="px-5 py-4 whitespace-nowrap">
                            <span class="text-sm font-mono font-medium text-emerald-400">JUAL-202402002</span>
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span class="text-sm text-slate-300">14 Februari 2024, 09:15</span>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-slate-500">Kode: PEL-000</span>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap">
        ...
        <div class="px-5 py-4 border-t border-slate-700 bg-slate-800/50">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-sm text-slate-400">
                    ...
                    dari <span class="font-medium text-slate-200">842</span>
                </div>
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="#" class="px-3 py-1 text-slate-400 hover:text-white hover:bg-slate-700 rounded text-sm transition-colors">85</a>
