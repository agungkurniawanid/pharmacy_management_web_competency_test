...
<body class="bg-slate-900 min-h-screen flex flex-col items-center justify-center p-4 font-sans antialiased text-slate-100">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-slate-800 rounded-2xl border border-slate-700 shadow-lg p-8 sm:p-10">
            ...
            <div class="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
                <div class="flex items-start gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-red-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div class="flex-1">
                        <h3 class="text-sm font-semibold text-red-400 mb-1">Gagal Login!</h3>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-xs font-medium text-blue-400 hover:text-blue-300 transition-colors">
                            Lupa password?
                        </a>
                    </div>
                ...
                <div class="flex items-center pt-1">
                    <input 
                        ...
                        class="size-4 rounded border-slate-700 bg-slate-900 text-blue-600 focus:ring-blue-500 focus:ring-offset-slate-900 transition-colors cursor-pointer"
                    />
                    <label for="remember" class="ml-2 text-sm text-slate-400 cursor-pointer select-none">
                        Ingat saya
                    </label>
                </div>
                ...
                <button 
                    type="submit"
                    class="w-full flex items-center justify-center gap-2 mt-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors duration-200"
                >
            ...
            <div class="mt-8 pt-6 border-t border-slate-700/50">
                <p class="text-xs text-center text-slate-500 flex items-center justify-center gap-1.5">
                    ...
                    Akses sistem diamankan dan dienkripsi.
                </p>
            </div>
        </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-xs text-slate-500">
                &copy; {{ date('Y') }} Pharmacy Management System.<br class="sm:hidden" /> All rights reserved.
            </p>
        </div>
